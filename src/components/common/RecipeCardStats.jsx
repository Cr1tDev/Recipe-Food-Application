  ...
  return (
    <>
      <div className="recipe-meta">
        <img className="recipe-meta__icon" src={minIcon} alt="" aria-hidden="true" />
        <span className="recipe-meta__text">{readyInMinutes} Min</span>
      </div>

      <div className="recipe-meta">
        <img className="recipe-meta__icon" src={servingsIcon} alt="" aria-hidden="true" />
        <span className="recipe-meta__text">{servings} Servings</span>
      </div>

      <div className="recipe-meta">
        <img className="recipe-meta__icon" src={diffIcon} alt="" aria-hidden="true" />
...
export default React.memo(RecipeCardStats);
